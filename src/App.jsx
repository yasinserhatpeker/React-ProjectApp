...
function App() {
  ...
  console.log(projectState);
   ...
   let content=<SelectedProject project={selectedProject} onDelete={handleDeleteProject} addTask={handleAddTask} deleteTask={handleDeleteTask} tasks={projectState.tasks}/>
